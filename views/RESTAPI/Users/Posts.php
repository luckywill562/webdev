...
&& isset($_POST['profile_id']) && !empty($_POST['profile_id'])){
    ...
    $user_data =[];
    foreach($PostTable->GetUserPosts((int)$_POST['profile_id'],(int)$_POST['limit'], $app->Table('follows')->SecurityLevel($_POST['profile_id'], $session_user_id),$page) as $key => $val){
    ...
    echo json_encode($app->msg(1,200,['posts' => $user_data,'has_next_page'=> $has_next]));
}